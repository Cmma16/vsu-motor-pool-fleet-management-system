...
export const PreventiveColumn = (handleView, handleEdit, handleDelete) => [
    {
        id: 'select',
        enableSorting: false,
        enableHiding: false,
                    ...
                    {}, // empty data object since we're not sending any data
                    {
                        onSuccess: () => {
                            toast.success('Record confirmed', {
                                description: 'The preventive maintenance record has been confirmed successfully',
                            });
                        },
                        onError: () => {
                            toast.error('Confirmation failed', {
                                description: 'The preventive maintenance record was not confirmed',
                            });
                        },
                    },
                );
