                                    ...
                                    <div className="flex flex-col gap-2 min-[400px]:flex-row">
                                        {auth.user ? (
                                            ...
                                            <>
                                                ...
                                                <Link
                                                    href={route('register')}
                                                    className="inline-flex h-12 items-center justify-center rounded-sm border border-[#19140035] bg-[#ffcc00] px-8 py-1.5 text-sm leading-normal text-[#1b1b18] hover:border-[#1915014a] dark:border-[#3E3E3A] dark:hover:border-[#62605b]"
                                                >
                                                    Register
                                                </Link>
                                            </>
